...
//#endif
    ...
    case WM_PRINTCLIENT: 
            {    
                ...
                HBITMAP hbmpTemp = ::CreateCompatibleBitmap(m_hDcPaint, rcClient.right - rcClient.left, rcClient.bottom - rcClient.top); 
                HBITMAP hOldBitmap = (HBITMAP) ::SelectObject(hdcTemp, hbmpTemp);

                m_pRoot->SetPos(rcClient);
                m_pRoot->DoPaint(hdcTemp, rcClient); 
                
                ::BitBlt(hdc, rcClient.left, rcClient.top, rcClient.right - rcClient.left,
                    rcClient.bottom - rcClient.top, hdcTemp, rcClient.left, rcClient.top, SRCCOPY);               
